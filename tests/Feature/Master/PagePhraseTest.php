...
class PagePhraseTest extends MasterBase
{
    public function setUp(): void
    {
        $this->hasTranslation = false;
        $this->modelName = 'page-phrase';
        $this->modelClass = PagePhrase::class;
    ...
    public function test_return_validation_error_when_required_fields_not_sent_on_create()
    {
        ...
        unset($rawData['page_id']);
        unset($rawData['phrase_id']);
    ...
    public function test_return_validation_error_when_send_dublicate_data_on_create()
    {
        ...
        $rawData = $this->rawData;
        $rawData['page_id'] = $model->page_id;
        $rawData['phrase_id'] = $model->phrase_id;
