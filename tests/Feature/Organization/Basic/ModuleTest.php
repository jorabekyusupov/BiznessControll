...
class ModuleTest extends OrganizationBase
{
    ...
    public function test_can_create()
    {
        ...
        $this->rawData['module_id'] = $this->relatedModels['module']->id;
    ...
    protected function createModels($count = 1){
        ...
        $models = $this->modelClass::factory($count)->create([
            'module_id' => $this->relatedModels['module']->id,
        ]);
    ...
    protected function createRelatedModels(){
        $this->relatedModels['module'] = MasterModule::factory()->create();
    }
