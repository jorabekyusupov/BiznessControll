...
class EmployeePermissionTest extends OrganizationBase
{
    public function setUp(): void
    {
        $this->hasTranslation = false;
        $this->modelClass = EmployeePermission::class;
        $this->modelName = 'employee-permission';
        $this->moduleShort = '';
    ...
    public function test_can_create()
    {
        ...
        $this->rawData = [
            ...
            'permission_id' => $this->relatedModels['permission']->id
        ];
    ...
    {
        $data = $data1 = $this->rawData;
        unset($data['employee_id']);
        unset($data1['permission_id']);
    ...
    public function test_can_update_item()
    {
        ...
        $this->rawData = [
            ...
            'permission_id' => $model->permission_id + 1
        ];
    ...
    protected function createRelatedModels(){
        ...
        $this->relatedModels['permission'] = Permission::factory()->create();
    }
