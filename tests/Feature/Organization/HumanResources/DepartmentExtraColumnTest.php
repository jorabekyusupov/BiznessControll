...
class DepartmentExtraColumnTest extends OrganizationBase
{
    public function setUp(): void
    {
        $this->modelClass = DepartmentExtraColumn::class;
        $this->modelName = 'department-extra-column';
        $this->moduleShort = 'hr';
    ...
    public function test_can_create()
    {
        ...
        $this->rawData['department_id'] = $this->relatedModels['department']->id;
        $this->rawData['extra_column_id'] = $this->relatedModels['extra_column']->id;
    ...
    public function test_return_dublicate_error_when_wring_data_send_on_create()
    {
        $model = $this->createModels()[0];
        $this->rawData['department_id'] = $model->department_id;
        $this->rawData['extra_column_id'] = $model->extra_column_id;
        $this->postJson($this->route($this->apiUrl . '.store'), $this->rawData, $this->getHeadersWithToken())
            ->assertStatus(422);
    }
    ...
    protected function createModels($count = 1){
        ...
        $this->createRelatedModels();
        $data = [
            'department_id' => $this->relatedModels['department']->id,
            'extra_column_id' => $this->relatedModels['extra_column']->id,
        ];
    ...
    protected function createRelatedModels(){
        ...
        $this->relatedModels['extra_column'] = ExtraColumn::factory()->create();
