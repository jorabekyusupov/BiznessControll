...
namespace App\Services\Organization\HumanResources\Employee;

use App\Repositories\Organization\HumanResources\Employee\EmployeeRepository;
...
class EmployeeService extends Service
{
    ...
    public function indexEmployee($data)
    {
        ...
        $model = $this->repository->queryView(['user', 'responsible:id,first_name,last_name,middle_name'])
